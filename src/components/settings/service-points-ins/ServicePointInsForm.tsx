...
interface ServicePointInsFormProps {
...
const ServicePointInsForm: React.FC<ServicePointInsFormProps> = ({
  formData,
  onCancel,
  onSave,
  onChange,
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            placeholder="รหัสจุดบริการ เช่น INS01"
          />
        </div>
        <div>
...
export default ServicePointInsForm;
